...
const Hero = () => {
  ...
  // Delayed visibility for hero section
  useEffect(() => {
    const timer = setTimeout(() => setIsVisible(true), 300);
    return () => clearTimeout(timer);
  }, []);

  // Optimized mouse movement handler with useCallback to avoid re-creation
  ...
  // Add mouse event listener for parallax effect
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`gsai-container relative text-center z-40 flex flex-col items-center transition-all duration-1000 ease-in-out ${
