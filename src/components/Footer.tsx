...
const Footer = () => {
  ...
  return (
    <footer className="bg-gsai-gray-900 pt-12 pb-6">
      <div className="gsai-container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-2xl font-bold text-white mb-6">
              <span className="text-gsai-red">Ghatak</span>
              <span className="text-gsai-gold"> Sports Academy</span> India
            </h3>
            <p className="text-gray-300 mb-4">
              Empowering Lives Through Martial Arts
            </p>
            <div className="flex space-x-4 mt-6">
              <a href="https://www.facebook.com/share/18w1TRaYAr/?mibextid=wwXIfr" className="text-white hover:text-gsai-red transition-colors" aria-label="Facebook">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"></path>
                </svg>
              </a>
              <a href="https://www.instagram.com/ghatakgsai/" className="text-white hover:text-gsai-red transition-colors" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* WhatsApp Business */}
              <a href="https://wa.me/+916394135988" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-500 transition-colors duration-300" aria-label="WhatsApp Business">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#home" className="text-gray-300 hover:text-gsai-red transition-colors">Home</a>
              </li>
              <li>
                <a href="#about" className="text-gray-300 hover:text-gsai-red transition-colors">About Us</a>
              </li>
              <li>
                <a href="#programs" className="text-gray-300 hover:text-gsai-red transition-colors">Programs</a>
              </li>
              <li>
                <a href="#gallery" className="text-gray-300 hover:text-gsai-red transition-colors">Gallery</a>
              </li>
              <li>
                <a href="#faq" className="text-gray-300 hover:text-gsai-red transition-colors">FAQ</a>
              </li>
              <li>
                <a href="#contact" className="text-gray-300 hover:text-gsai-red transition-colors">Contact</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#programs" className="text-gray-300 hover:text-gsai-red transition-colors">Karate</a>
              </li>
              <li>
                <a href="#programs" className="text-gray-300 hover:text-gsai-red transition-colors">Taekwondo</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg className="w-5 h-5 text-gsai-red mt-1 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <p className="text-gray-400 text-sm flex items-center">
              <span className="animate-pulse-glow text-gsai-red mr-2">♦</span>
              <span>Empowering Lives Through Martial Arts</span>
              <span className="animate-pulse-glow text-gsai-red ml-2">♦</span>
            </p>
            <p className="text-gray-500 text-xs mt-2 text-center md:text-right">
              Designed & Maintained by <a href="https://www.ellowdigitals.me" className="text-gsai-red">EllowDigitals</a>
            </p>
          </div>
        </div>
