...
const AnimatedSphere = () => {
  ...
  return (
    <Sphere args={[1, 64, 64]} ref={sphereRef}>
      <meshPhongMaterial>
        <primitive object={new THREE.Color("#bd0000")} attach="color" />
        <primitive object={new THREE.Color("#470000")} attach="emissive" />
  ...
  return (
    <mesh ref={ringRef} rotation={[0, 0, 0]} position={[0, 0, 0]}>
      ...
      <meshStandardMaterial>
        <primitive object={new THREE.Color("#d4af37")} attach="color" />
