  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-br from-black/80 to-gray-900/80 backdrop-blur-md p-6">
        <h3 className="text-2xl sm:text-3xl font-bold mb-4 bg-gradient-to-r from-gsai-gold to-amber-400 bg-clip-text text-transparent">
          Our Location
        </h3>
      ...
      <div className="relative w-full h-[350px] sm:h-[450px] overflow-hidden">
        ...
        >
          ...
          >
            ...
            <motion.a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-gsai-red to-gsai-red-dark text-white font-medium rounded-lg transition-all"
        ...
        <div className="relative w-full h-full">
          ...
          <img
            src="/images/map.png"
            alt="Map showing Ghatak Sports Academy location"
            className="w-full h-full object-cover transition-opacity duration-500"
            loading="lazy"
            onError={(e) => {
              const target = e.target as HTMLImageElement;
              target.src =
                'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3557.7129062858908!2d81.02444217543946!3d26.912605076647186!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3999596def6ea9c7%3A0x23d2ceb539bff92!2sGhatak%20Sports%20Academy%20India!5e0!3m2!1sen!2sin!4v1746478930599!5m2!1sen!2sin';
            }}
          />
        </div>
      </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  Naubasta Pulia, Takrohi Road, Amrai Gaon, Indira Nagar,<br />
                  Lucknow, U.P. - 226028
                </p>
              </div>
            </div>
          ...
          >
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  Monday - Saturday: 2:00 PM - 7:00 PM<br />
