const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/About-DzJpLMnE.js","assets/index-B2g8npnE.js","assets/index-BRGNIapd.css","assets/Founder-BbVnAVM2.js","assets/Programs-Dm7XwfwZ.js","assets/Gallery-CHS17cL8.js","assets/FAQ-BwgrmJ--.js","assets/Contact-gl4F677q.js","assets/Affiliations-npCTi0YT.js","assets/Footer-DlP8USY_.js"])))=>i.map(i=>d[i]);
import{r as We,j as te,c as _r,_ as xn}from"./index-B2g8npnE.js";const Oo=()=>{const[i,e]=We.useState(!1),[t,n]=We.useState(!1),[r,s]=We.useState(!0),[a,o]=We.useState(0),l=()=>e(h=>!h),c=We.useMemo(()=>[{name:"Home",href:"#hero"},{name:"About",href:"#about"},{name:"Programs",href:"#programs"},{name:"Gallery",href:"#gallery"},{name:"FAQ",href:"#faq"},{name:"Contact",href:"#contact"}],[]);return We.useEffect(()=>{const h=()=>{const f=window.scrollY;n(f>80),s(f<a),o(f)};return window.addEventListener("scroll",h,{passive:!0}),()=>window.removeEventListener("scroll",h)},[a]),te.jsxs("nav",{className:_r("fixed w-full z-50 transition-all duration-300",t?"bg-black bg-opacity-90 backdrop-blur-md shadow-md py-2":"py-6",r?"translate-y-0":"-translate-y-full"),children:[te.jsxs("div",{className:"container mx-auto px-4 md:px-8 flex items-center justify-between",children:[te.jsxs("a",{href:"#hero",className:"flex items-center space-x-3",children:[te.jsx("img",{src:"/images/logo.png",alt:"Ghatak SAI Logo",className:"w-12 h-12 object-contain"}),te.jsxs("span",{className:"text-2xl font-bold text-white",children:[te.jsx("span",{className:"text-gsai-red",children:"G"}),"S",te.jsx("span",{className:"text-gsai-gold",children:"AI"})]})]}),te.jsxs("div",{className:"hidden md:flex items-center space-x-8",children:[c.map(({name:h,href:f})=>te.jsx("a",{href:f,className:"text-white hover:text-gsai-red transition-colors duration-300 font-medium",children:h},h)),te.jsx("a",{href:"https://forms.gle/LTYn59kPWkQgC3VR7",className:"gsai-btn animate-pulse-glow",children:"Join Now"})]}),te.jsx("div",{className:"md:hidden",children:te.jsx("button",{onClick:l,className:"text-white focus:outline-none","aria-label":"Toggle navigation menu",children:te.jsx("svg",{className:_r("w-6 h-6 transition-transform duration-300",i&&"rotate-90"),fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:i?te.jsx("path",{d:"M6 18L18 6M6 6l12 12",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}):te.jsx("path",{d:"M4 6h16M4 12h16M4 18h16",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})})})})]}),te.jsx("div",{className:_r("md:hidden overflow-hidden transition-all duration-300 ease-in-out mx-4 mt-2 glass-card",i?"max-h-[500px] opacity-100":"max-h-0 opacity-0 invisible"),children:te.jsxs("div",{className:"flex flex-col space-y-3 p-4",children:[c.map(({name:h,href:f})=>te.jsx("a",{href:f,onClick:()=>e(!1),className:"text-white hover:text-gsai-red transition-colors duration-300 py-2 px-4 rounded",children:h},h)),te.jsx("a",{href:"#contact",onClick:()=>e(!1),className:"gsai-btn text-center",children:"Join Now"})]})})]})},Bo=768;function Ns(){const[i,e]=We.useState(!1);return We.useEffect(()=>{const t=()=>{e(window.innerWidth<Bo)};return t(),window.addEventListener("resize",t),()=>{window.removeEventListener("resize",t)}},[]),i}/**
 * @license
